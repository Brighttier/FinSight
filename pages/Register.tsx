    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <Card className="w-full max-w-md shadow-xl border-slate-200">
        <CardHeader className="space-y-1">
          ...
          <p className="text-center text-slate-500 text-sm">Enter your details to get started</p>
        </CardHeader>
        <CardContent>
          ...
          <button
            ...
            disabled={loading}
            className="inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium transition-colors border border-slate-300 bg-white hover:bg-slate-50 h-10 px-4 py-2 w-full disabled:opacity-50"
          >
